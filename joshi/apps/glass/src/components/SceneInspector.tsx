        ...
        <Dialog.Content className="scene-inspector" aria-describedby="scene-inspector-description" data-shortcuts-disabled="true">
          ...
          <div className="inspector-scroll">
            ...
            <section aria-labelledby="choice-context-title">
              ...
              <p>These sets remain distinct. Being served, filtered into view, visible to you (viewport), marked by your pointer, interacted with, and compared are not treated as synonyms.</p>
